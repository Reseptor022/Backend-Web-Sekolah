...
$result = mysqli_query($mysqli, "SELECT * FROM tb_menu WHERE id_menu=$id_menu");
...
if (isset($_POST['update'])) {
    ...
    $result = mysqli_query($mysqli, "UPDATE tb_menu SET nama_menu='$nama_menu' WHERE id_menu=$id_menu");
    // update user data
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="../../admin/menu/edit.php" method="post">
