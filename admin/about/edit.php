...
$result = mysqli_query($mysqli, "SELECT * FROM tb_about WHERE id_about=$id_about");
...
if (isset($_POST['update'])) {
    ...
    $result = mysqli_query($mysqli, "UPDATE tb_about SET judul='$judul',deskripsi='$deskripsi' WHERE id_about=$id_about");
    // update user data
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="card-tools">
                                        ...
                                        <a href="../../admin/about/edit.php?page=about" class="btn btn-info">Kembali</a>
                                    </div>
                                    <!-- /.card-tools -->
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="../../admin/about/edit.php" method="post">
                                        <input type="hidden" name="id_about" value="<?= $id_about ?>">
